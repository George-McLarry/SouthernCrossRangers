...
interface FunctionalAdminPanelProps {
  onLogout: () => void
}
...
export function FunctionalAdminPanel({ onLogout }: FunctionalAdminPanelProps) {
  ...
  const menuItems = [
    ...
    { id: 'mercantile', label: 'Mercantile', icon: '🛒' },
  ...
  const handleContentUpdate = (section: string, field: string, value: any) => {
    ...
    alert(`✅ ${section} ${field} updated successfully!`)
  }
  ...
  const handleProductUpdate = (productId: string, field: string, value: any) => {
    setWebsiteContent(prev => ({
      ...
      mercantile: {
        ...prev.mercantile,
        products: prev.mercantile.products.map(product =>
  ...
  const handleAddProduct = () => {
    ...
    if (name && description && price > 0) {
      ...
      setWebsiteContent(prev => ({
        ...
        mercantile: {
          ...prev.mercantile,
          products: [...prev.mercantile.products, newProduct]
        }
      }))
  ...
  const handleDeleteProduct = (productId: string) => {
    if (confirm('Are you sure you want to delete this product?')) {
      setWebsiteContent(prev => ({
        ...
        mercantile: {
          ...prev.mercantile,
          products: prev.mercantile.products.filter(p => p.id !== productId)
        }
      }))
  ...
  const renderContent = () => {
    switch (activeTab) {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="parchment-section text-center">
                ...
                <div className="text-2xl font-bold">{websiteContent.stats.tracks}</div>
                <div className="text-sm">Total Tracks</div>
              </div>
              <div className="parchment-section text-center">
                <div className="text-3xl mb-2">🛒</div>
                <div className="text-2xl font-bold">{websiteContent.stats.orders}</div>
                <div className="text-sm">Orders</div>
              </div>
              <div className="parchment-section text-center">
                <div className="text-3xl mb-2">📧</div>
                <div className="text-2xl font-bold">{websiteContent.stats.subscribers}</div>
                <div className="text-sm">Subscribers</div>
              </div>
              <div className="parchment-section text-center">
                <div className="text-3xl mb-2">👥</div>
                <div className="text-2xl font-bold">{websiteContent.stats.visitors.toLocaleString()}</div>
      ...
      case 'homepage':
        return (
          <div className="space-y-6">
            <h2 className="header-2 text-3xl mb-6">Homepage Content</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => handleContentUpdate('homepage', 'title', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="text" 
                    value={websiteContent.homepage.tagline}
                    onChange={(e) => handleContentUpdate('homepage', 'tagline', e.target.value)}
                    className="form-input"
                  />
                </div>
                <div>
                  ...
                  <textarea 
                    rows={3}
                    value={websiteContent.homepage.heroText}
                    onChange={(e) => handleContentUpdate('homepage', 'heroText', e.target.value)}
                ...
                <div>
                  ...
                  <textarea 
                    rows={4}
                    value={websiteContent.homepage.aboutText}
                    onChange={(e) => handleContentUpdate('homepage', 'aboutText', e.target.value)}
                    className="form-textarea"
                  />
                </div>
              </div>
        ...
        return (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="header-2 text-3xl">Product Management</h2>
              <button 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {websiteContent.mercantile.products.map((product) => (
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                  <button className="gold-button py-3 px-6">
                    📧 Send to All Subscribers ({websiteContent.stats.subscribers})
                  </button>
